...
// FUNCIÓN  Intercambio - Pasaje de parámetros POR DIRECCIÓN
...
void intercambio (int *a, int *b)
{
	...
	cout<<"el contenido a lo que apunta la variable a es: "<< *a <<endl;
	cout<<"la posicion de memoria de la variable a es: "<< &a <<endl;
	cout<<"el contenido de la variable a es: "<<a<<endl;
	cout<<"el contenido a lo que apunta la variable b es: "<< *b <<endl;
